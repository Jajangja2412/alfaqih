        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="/admin-kas/simpan" class="form-material m-t-40" enctype="multipart/form-data">
                        @csrf
                        ...
                        <label>Kas Keluar</label>
                            ...
                            <input type="hidden" class="form-control form-control-line" value="kas keluar"
