...
<head>
    ...
    <!-- Favicon icon -->
    {{--  <link rel="icon" type="image/png" sizes="30x30" href="{{ asset('assets/images/alfaqih.jpeg') }}">  --}}
    <link rel="shortcut icon" type="image/png" href="{{ asset('favicon.ico') }}">
    {{--  <link rel="shortcut icon" type="image/png" href="{{ asset('assets/images/alfaqih.jpeg') }}">  --}}
    <title>Saldo Alfaqih | Dashboard</title>
    <!-- This page CSS -->
    <!--alerts CSS -->
...
<body class="skin-green fixed-layout">
    ...
    <div class="preloader">
        <div class="loader">
            ...
            <p class="loader__label">Keuangan JS</p>
        </div>
    </div>
    <!-- ============================================================== -->
    ...
    <div id="main-wrapper">
        ...
        <!-- ============================================================== -->
        @include('auth.layouts.left_sidebar')
        <!-- ============================================================== -->
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- ============================================================== -->
                {{-- @include('auth.layouts.breadcrumb') --}}
                <!-- ============================================================== -->
                ...
                <!-- ============================================================== -->
                <!-- .right-sidebar -->
                @include('auth.layouts.right_sidebar')
                <!-- ============================================================== -->
                <!-- End Right sidebar -->
                <!-- ============================================================== -->
            </div>
